...
$.getScript("http://determinatioanima.github.io/mc-client.js").done(function () {
...
function createBlockPos(x, y, z, isRelative) {
    var prefix = isRelative === 'relative' ? "~" : "";
...
(function (ext) {
    ...
    ext._getStatus = function () {
        if (loadFailed) {
            ...
            return { status: 2, msg: "CC client is not loaded" };else return connectionStatus;
    };
    ...
    var descriptor = {
        blocks: [['w', 'Move %m.sixDirections', 'move', 'forward'], ['w', 'Turn %m.rotateDirections', 'turn', 'left'], ['w', 'Teleport to the player', 'tpToPlayer'], ['w', 'Use or place item in inventory slot %n at %m.sixDirections', 'place', 1, 'forward'], ['w', 'Destroy %m.sixDirections', 'destroy', 'forward'], ['w', 'Till %m.sixDirections', 'till', 'forward'], ['w', 'Attack %m.sixDirections', 'attack', 'forward'], ['w', 'Collect %s', 'collect', 'all'], ['w', 'Drop %n item(s) in inventory slot %n to %m.fourDirections', 'drop', 1, 1, 'forward'], ['w', 'Drop all item in inventory to %m.fourDirections', 'dropAll', 'forward'], ['b', 'Detect %m.sixDirections', 'detect', 'forward'], ['R', 'Inspect at %m.sixDirections', 'inspect', 'forward'], ['R', 'Inspect data at %m.sixDirections', 'inspectdata', 'forward'], ['r', 'Block name %m.blocks', 'getBlockName', blocks[0]], ['r', 'Decoration name %m.decorations', 'getDecorationName', decorations[0]], ['r', 'Tool name %m.tools', 'getToolName', tools[0]], ['r', 'Miscellaneous name %m.miscellaneous', 'getMiscellaneousName', miscellaneous[0]], ['R', 'Get item detail in the inventory slot %n', 'getItemDetail', 1], ['R', 'Get item space in the inventory slot %n', 'getItemSpace', 1], ['R', 'Get number of item in the inventory slot %n', 'getItemCount', 1], ['w', 'Transfer item from inventory slot %n to %n quantity %n', 'transferTo', 1, 1, 1], ['b', 'Detect Redstone at %m.sixDirections', 'detectRedstone', 'forward'], ['w', 'Clone blocks from %m.positionType position %n %n %n to %m.positionType position %n %n %n to %m.positionType position %n %n %n', 'clone', 'relative', 1, 1, 1, 'relative', 1, 1, 1, 'relative', 1, 1, 1], ['w', 'Execute command %s on behalf of %s at %m.positionType position %n %n %n', 'executeAsOther', ' ', ' ', 'relative', 1, 1, 1], ['w', 'Fill from %m.positionType position %n %n %n to %m.positionType position %n %n %n with %s using tile data %n', 'fill', 'relative', 1, 1, 1, 'relative', 1, 1, 1, ' ', 0], ['w', 'Give %n item(s) %s to target %s', 'give', 1, ' ', ' '], ['w', 'Kill target %s', 'kill', ' '], ['w', 'Set block at %m.positionType position %n %n %n to block type %s using tile data %n', 'setBlock', 'relative', 1, 1, 1, ' ', 0], ['w', 'Summon entity type %s at %m.positionType position %n %n %n', 'summon', ' ', 'relative', 1, 1, 1], ['b', 'Tests whether a block type %s is in a %m.positionType position %n %n %n', 'testForBlock', ' ', 'relative', 1, 1, 1], ['b', 'Tests whether the pattern between %m.positionType position %n %n %n to %m.positionType position %n %n %n is matched at %m.positionType position %n %n %n', 'testForBlocks', 'relative', 1, 1, 1, 'relative', 1, 1, 1, 'relative', 1, 1, 1], ['w', 'Teleport target %s to target %s', 'tpToTarget', ' ', ' '], ['w', 'Teleport target %s to %m.positionType position %n %n %n', 'tpToPos', ' ', 'relative', 1, 1, 1], ['w', 'Set time to %m.timeType', 'timeSetByName', 'day'], ['w', 'Set time to %n', 'timeSetByNumber', 1], ['w', 'Change weather to %m.weatherType', 'weather', 'clear']],
        menus: {
